...
<Card title="OAuth 2.1 Security">
  ...
  <p>The specification explicitly supports flows where the MCP server delegates the actual user login process to a trusted <strong>Third-Party Identity Provider</strong> – like Auth0.</p>
</Card>
