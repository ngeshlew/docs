...
<Tabs>
<Tab title="Beginner Path" icon="user">
**Start here if you're new to AI**

<Steps>
<Step title="Master AI Fundamentals">
Complete this Foundations module to understand core concepts
</Step>
<Step title="Learn Basic Prompting">
Move to [Prompting Mastery](../prompting-structured-outputs/index) for structured outputs
</Step>
<Step title="Explore Simple UX">
Try [Streaming UX](../streaming-ux/index) for user interface basics
</Step>
<Step title="Production Basics">
Learn [Safety & Security](../safety-security/index) fundamentals
</Step>
</Steps>
</Tab>

<Tab title="Intermediate Path" icon="users">
**For developers with some AI experience**

<Steps>
<Step title="Advanced AI Concepts">
Explore [AI Fluency Framework](../ai-fluency-framework/index) for strategic thinking
</Step>
<Step title="System Architecture">
Learn [RAG Systems](../rag/index) and [Agents](../agents-orchestration/index)
</Step>
<Step title="Complex UX Patterns">
Master [AI UX & Behavior](../ai-ux-behavior/index) design
</Step>
<Step title="Production Operations">
Implement [Cost & Latency](../cost-latency/index) optimization
</Step>
</Steps>
</Tab>

<Tab title="Advanced Path" icon="crown">
**For senior practitioners and architects**

<Steps>
<Step title="Cutting-Edge Research">
Dive into [Ecosystem Deep Dives](../ecosystem-deep-dives/index)
</Step>
<Step title="Enterprise Architecture">
Master [MCP](../mcp/index) and [MLOps](../productization-mlops/index)
</Step>
<Step title="Team Collaboration">
Learn [Collaboration with Engineers](../collaboration-with-engineers/index)
</Step>
<Step title="Capstone Project">
Build your [Customer Service Chatbot](../../capstone/index)
</Step>
</Steps>
</Tab>
</Tabs>
...
<CardGroup cols={3}>
  <Card title="Prompt Engineering" icon="edit" href="../prompting-structured-outputs/index">
    Master structured outputs and advanced prompting techniques
  </Card>
  <Card title="AI Architecture" icon="puzzle" href="../mcp/index">
    Learn Model Context Protocol and system integration
  </Card>
  <Card title="Safety & Security" icon="shield" href="../safety-security/index">
    Build safe and trustworthy AI systems with Claude
  </Card>
  <Card title="Multimodality" icon="image" href="../multimodality/index">
    Work with text, images, and other data types
  </Card>
  <Card title="Evaluation" icon="check-circle" href="../evaluation-observability/index">
    Measure and improve AI system performance
  </Card>
  <Card title="Production" icon="building" href="../productization-mlops/index">
...
> **Note:** The following article is reproduced verbatim from  
> Paweł Huryn, *The Product Compass* (2025):  
> [WTF is an AI Product Manager?](https://www.productcompass.pm/p/what-is-an-ai-product-manager)  
> for internal educational use only (non-profit).
...
An AI PM is a PM who works on AI-powered products or features. This means they need to understand:

- How AI technologies work and their limitations
- How to design AI-powered user experiences
- How to evaluate AI model performance
- How to work with AI/ML teams effectively
- How to manage AI-specific risks and challenges

## 3. What's Special About AI Product Manager?

AI PMs face unique challenges:

- **Uncertainty**: AI models can be unpredictable and may not always work as expected
- **Technical complexity**: Understanding AI capabilities and limitations
- **Ethical considerations**: Managing bias, privacy, and responsible AI use
- **Rapid evolution**: Keeping up with fast-moving AI technology
- **User experience**: Designing interfaces that work well with AI's probabilistic nature

The key is to approach AI product management with the same fundamental PM skills while adapting to the unique characteristics of AI-powered products.
...
4. Differences Between Transformers and the Human Brain
5. Conclusions
...
Neural networks are the foundation of modern AI systems. They are inspired by the human brain and consist of interconnected nodes (neurons) that process information.

## 3. How Transformers and LLMs Work

Transformers are a type of neural network architecture that has revolutionized natural language processing. Large Language Models (LLMs) are built on transformer architecture and can understand and generate human-like text.

## 4. Differences Between Transformers and the Human Brain

While transformers are inspired by the brain, they work quite differently:

- **Parallel processing**: Transformers process all words simultaneously, while the brain processes sequentially
- **Attention mechanism**: Transformers use attention to focus on relevant parts of the input
- **Training**: Transformers learn from massive amounts of text data, while the brain learns from diverse experiences

## 5. Conclusions

Understanding these fundamental concepts is crucial for AI Product Managers. It helps you:

- Communicate effectively with AI/ML teams
- Make informed product decisions
- Understand the capabilities and limitations of AI systems
- Design better AI-powered user experiences

> **Note:** The following article is reproduced verbatim from  
> Paweł Huryn, *The Product Compass* (2025):  
> [The Ultimate AI PM Learning Roadmap](https://www.productcompass.pm/p/ai-product-management-learning-roadmap)  
> for internal educational use only (non-profit).

# The Ultimate AI PM Learning Roadmap

### An extended edition with dozens of AI PM resources: definitions, courses, guides, reports, tools, and step-by-step tutorials. Updated: Jul 22, 2025.
...
## 2. AI Models You Should Know

As an AI PM you will most likely work with LLMs, as they are the most cost-effective. But just in case, here are 8 other terms you might come across:
...
This roadmap provides a structured approach to becoming an AI Product Manager, covering:
...
The goal is to provide a comprehensive learning path that combines theoretical knowledge with practical application.

> **Note:** The following article is reproduced verbatim from  
> ProductCompass Team, *ProductCompass* (2025):  
> [The Ultimate AI PM Learning Roadmap](https://www.productcompass.pm/p/ai-product-management-learning-roadmap)  
> for internal educational use only (non-profit).
...
This comprehensive roadmap aggregates resources, templates, and step-by-step guides for AI PMs and AI builders. If you had to learn AI Product Management again, this is where you would start.
...
As an AI PM you will most likely work with LLMs, as they are the most cost-effective. But just in case, here are 8 other terms you might come across, explained by Generative AI:
...
Use these platforms to experiment with training and validation data sets and parameters such as epochs. No coding required:

- **OpenAI Platform** (start here, recommended)
...
RAG is a technique that combines the power of large language models with external knowledge retrieval to provide more accurate and up-to-date responses.

### Key Components of RAG

1. **Retriever**: Searches through a knowledge base to find relevant documents
2. **Generator**: Uses the retrieved context along with the original query to generate responses
3. **Knowledge Base**: The external data source that the retriever searches through

### Benefits of RAG

- **Accuracy**: Provides more factual and up-to-date information
- **Transparency**: Can cite sources and provide references
- **Customization**: Can be tailored to specific domains or use cases
- **Reduced Hallucination**: Grounds responses in actual data rather than training knowledge

### Implementation Considerations

- **Chunking Strategy**: How to split documents into searchable pieces
- **Embedding Models**: Choosing the right model for vector similarity search
- **Re-ranking**: Improving search results with additional relevance scoring
- **Evaluation**: Measuring the quality of retrieval and generation

## AI Product Management Certification

Consider the AI Product Management Certification - a 6-week cohort program that provides hands-on experience and networking opportunities for AI PMs.

> **Note:** The following article is reproduced verbatim from  
> Google AI Blog, *Google AI Blog* (2025):  
...
# AlphaFold 3: Predicting Life's Molecular Interactions

AlphaFold 3 represents a revolutionary advancement in AI-powered molecular biology. Developed by Google DeepMind and Isomorphic Labs, this groundbreaking model can predict the structure and interactions of all life's molecules with unprecedented accuracy.

## Key Breakthrough

For interactions of proteins with other molecule types, AlphaFold 3 shows at least a 50% improvement compared with existing prediction methods. For some important categories of interaction, accuracy has doubled.

## What AlphaFold 3 Can Model

AlphaFold 3 goes beyond proteins to model:

- **Large biomolecules**: proteins, DNA, and RNA
- **Small molecules (ligands)**: encompassing many drugs
- **Chemical modifications**: that control healthy cell functioning
- **Molecular interactions**: revealing how all components fit together

## Technical Innovation

### Advanced Architecture
- **Improved Evoformer module**: Enhanced deep learning architecture from AlphaFold 2
- **Diffusion network**: Similar to AI image generators, assembles predictions by starting with a cloud of atoms and converging on the most accurate molecular structure
- **Holistic computation**: Processes entire molecular complexes as unified systems

### Training Coverage
AlphaFold 3's training now covers all of life's molecules, enabling it to unify scientific insights across the biological spectrum.

## Impact on Drug Discovery

AlphaFold 3 creates new capabilities for drug design by predicting:

- **Ligand binding**: How drug-like molecules bind to proteins
- **Antibody interactions**: Critical for understanding immune responses
- **Protein-protein interactions**: Essential for therapeutic development

The model is 50% more accurate than traditional methods on the PoseBusters benchmark, making it the first AI system to surpass physics-based tools for biomolecular structure prediction.

## Real-World Applications

### Isomorphic Labs Collaboration
Using AlphaFold 3 with complementary AI models, Isomorphic Labs is working on:

- Internal drug design projects
- Pharmaceutical partnerships
- Novel approaches to previously unreachable disease targets

### Research Applications
- **Malaria vaccines**: Enhanced understanding of pathogen interactions
- **Cancer treatments**: Better modeling of therapeutic targets
- **Enzyme design**: Improved industrial and medical applications
- **Biorenewable materials**: Sustainable technology development
- **Agricultural resilience**: Creating more robust crops

## AlphaFold Server: Free Research Tool

Google DeepMind launched the AlphaFold Server as a free platform for non-commercial research, offering:

- **Easy accessibility**: Just a few clicks to generate predictions
- **Broad capability**: Models proteins, DNA, RNA, ligands, ions, and chemical modifications
- **No barriers**: Accessible regardless of computational resources or ML expertise

## Responsible Development

AlphaFold 3's development included extensive consultation with over 50 domain experts across:

- **Biosecurity**: Understanding potential risks
- **Research community**: Ensuring beneficial applications
- **Industry**: Facilitating practical implementation

## Scientific Impact

AlphaFold 2 has already been:
- Cited more than 20,000 times
- Used by millions of researchers globally
- Recognized with the Breakthrough Prize in Life Sciences
- Applied to discoveries in malaria vaccines, cancer treatments, and enzyme design

## Future Implications

AlphaFold 3 brings the biological world into high definition, allowing scientists to:

- See cellular systems in all their complexity
- Understand how molecular connections affect biological functions
- Accelerate drug design and genomics research
- Advance biorenewable materials and agricultural science

This represents just the beginning of AlphaFold 3's potential impact on scientific discovery and human health.
