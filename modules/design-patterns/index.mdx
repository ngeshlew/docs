...
![The 3 user-interface paradigms of computing are batch processing, command-based interaction, and intent-based outcome specification.](https://media.nngroup.com/media/editor/2023/06/16/ai-paradigms-24.jpg)
<sub>Source: *Nielsen Norman Group*, NN/g Team (2025).</sub>

![The 3 user-interface paradigms of computing are batch processing, command-based interaction, and intent-based outcome specification.](https://media.nngroup.com/media/editor/2023/06/16/ai-paradigms-25.jpg)
<sub>Source: *Nielsen Norman Group*, NN/g Team (2025).</sub>
...
![](https://media.nngroup.com/media/editor/2023/06/10/ai-generated-illustration-two-red-moons-1.jpg)
<sub>Image produced by Bing Image Creator from the prompt, "Make me a drawing suitable for the cover of a pulp science-fiction magazine, showing a cowboy in a space suit on an airless planet with two red moons in the heavens."</sub>
...
> **Note:** The following article is reproduced verbatim from  
> Sharang Sharma, *UX Design* (2025):  
> [AI tools + AI fluency + human advantage = AI-native designer](https://uxdesign.cc/ai-tools-ai-fluency-human-advantage-ai-native-designer-bade3494e7aa)  
> for internal educational use only (non-profit).
...
![Sharang Sharma](https://miro.medium.com/v2/resize:fill:64:64/1*qPk4Z8BYN6qYzwBK6Frc7g.png)
<sub>Source: *UX Design*, Sharang Sharma (2025).</sub>
...
1. AI fluency: Learning how to design for probabilistic systems
1. Human-advantage: Strengthening moats like craft, agency and judgment to stay ahead of automation
1. Together with strategic thinking and human-centric skills, these pillars shape our path toward becoming an AI-native designer
...
If you're looking to sharpen your prompting skills, these resources are a great place to start- Google Prompting Essentials- IBM — Prompt Engineering Guide - OpenAI — Prompting Guide
...
- What Is ChatGPT Doing … and Why Does It Work? — by Stephen Wolfram's provides a foundational understanding of how LLM works
- AI for Everyone — a non-technical course by Andrew NG, will help you understand AI technologies
- Introduction to Generative AI — introductory level course aimed at explaining what Generative AI is, how it is used, and how it differs from traditional machine learning methods
...
> **Note:** The following article is reproduced verbatim from  
> Figma Team, *Figma* (2025):  
> [What's working, what's not, for designers and developers?](https://www.figma.com/reports/designer-developer-trends/)  
> for internal educational use only (non-profit).
...
### Are developers and designers in demand in 2025?
...
### What is the collaborative product design process?
...
### What is the best collaborative product design process?
...
> **Note:** The following article is reproduced verbatim from  
> Renee De Four, *Anthology of One* (2025):  
> [Sparkle First Impressions: AI File Organizer](https://aooarchived.substack.com/p/sparkle-first-impressions-ai-file)  
> for internal educational use only (non-profit).

# Sparkle First Impressions: AI File Organizer

### Come along with me as I install Sparkle and watch it Marie Kondo my files ✨

Sparkle organizes your Mac's files using AI into the following folders:

- **AI Library** - this is the custom folder hierarchy that Sparkle creates. Recent files are moved here after 3 days.
- **Manual Library** - files in those folders will not be organized by Sparkle.
- **Recents** - all new files added to a folder organized by Sparkle are moved to the Recents folder. These files stay here for 3 days.

From my onboarding experience, Sparkle comes with a 7 day free trial then costs $20/month or $200/year USD which also comes with access to Every essays, their Discord community as well as their other AI tools Spiral and Lex.

If you'd like to try Sparkle, consider using my referral link so that I can get 7 more free days! 🤗

I kind of feel like I should say here that I discovered Sparkle on my own and found it genuinely interesting — I've got no affiliation to these Every people.

> **Note:** The following article is reproduced verbatim from  
> Jehad Affoneh, *My Name Is Jehad* (2025):  
> [MCP for Designers: a Short Explainer Video on Model Context Protocol](https://www.mynameisjehad.com/mcp-for-designers-a-short-explainer-video-on-model-context-protocol/)  
> for internal educational use only (non-profit).

# MCP for Designers: a Short Explainer Video on Model Context Protocol

One of the most exciting and most challenging aspects of building AI-first experiences is keeping pace with an industry that evolves so rapidly. At Toast, we're addressing this challenge by sharing our insights frequently, tailoring our communication to reach different audiences effectively.

Over the past few months, you've likely been hearing more and more about Model Context Protocol (MCP) and the way it'll reshape how we create AI-first experiences. If you're a designer who's heard MCP mentioned, it might have seemed like technical mumbo jumbo or an underlying tech that didn't feel essential to your role. However, MCP represents a fundamental shift that impacts not only how we build experiences but also what we build.

This is a short explainer video Brenna (our lead Designer on Sous Chef, our AI assistant for operators) and I worked on together last week. I hope it helps more designers get closer to the way MCP will shape their future experiences and it may also be helpful for many non-Design non-technical teams within your company!

Note: this video is provided for informational purposes only and any Toast specific details are subject to change.

> **Note:** The following article is reproduced verbatim from  
> Jehad Affoneh, *My Name Is Jehad* (2025):  
> [Approaching AI as a design leader: rethinking the customer journey with a layer of AI-first](https://www.mynameisjehad.com/approaching-ai-as-a-design-leader-rethinking-the-customer-journey-with-a-layer-of-ai-first/)  
> for internal educational use only (non-profit).
...
> **Note:** The following article is reproduced verbatim from  
> Jehad Affoneh, *My Name Is Jehad* (2025):  
> [Approaching AI as a design leader: start delivering small miracles to your customers now](https://www.mynameisjehad.com/approaching-ai-as-a-design-leader-start-delivering-small-miracles-to-your-customers-now/)  
> for internal educational use only (non-profit).
...
These miracles can be as simple as making it easier to write email marketing campaigns, respond to customer feedback, or even more out of the box personalization through basic assistant-level features.
...
## The Importance of Small Miracles

The importance of focusing on small miracles first comes from three key pieces:

1. **Score some wins.** Part of the cultural transformation of your team and teams around you is their ability to see a small amount of work deliver very high amount of impact. The goal is to focus teams on the power thinking AI-first brings to even the smallest of user interactions with your product.
2. **Focus on customer-first delivery with a AI-first mindset.** You're bringing an AI-first mindset with a customer-first approach. Most customers benefit most, in the short term, from your speed to market over transformative experiences that may take a while.
3. **Transformative experiences may require re-thinking existing work.** Almost all transformative experiences will require work that's even if technologically possible, it remains disruptive. The key here is that you do want to be disruptive but without scoring wins or being customer-first, your disruption is likely to be slower.
...
> **Note:** The following article is reproduced verbatim from  
> Jehad Affoneh, *My Name Is Jehad* (2025):  
> [Approaching AI as a design leader: starting with a culture of experimentation](https://www.mynameisjehad.com/approaching-ai-as-a-design-leader-starting-with-a-culture-of-experimentation/)  
> for internal educational use only (non-profit).
...
This is a moment where design teams can lead or co-lead the way. Context matters here so this isn't a recipe for all but it is a recipe for many.
...
1. Leading the way on a culture of experimentation driven primarily through prototyping, trying tools, and experimenting with approaches.
2. Delivering small miracles at 10x the speed and the ways these miracles help set the pace for how transformative this could be for the experience.
3. Leading the way with a customer journey built with an AI-first lens that can help shape the end to end experience for customers at the same time it shapes the way teams internally work to get there.
...
> **Note:** The following article is reproduced verbatim from  
> Figma Team, *Figma Help Center* (2025):  
> [Bring style context from a Figma Design library into Figma Make](https://help.figma.com/hc/en-us/articles/33024539096471-Bring-style-context-from-a-Figma-Design-library-into-Figma-Make)  
> for internal educational use only (non-profit).

# Bring style context from a Figma Design library into Figma Make

Figma Make is available for Full seats on paid plans. You can try Figma Make on other seats and plans.

To create functional prototypes and web apps with AI assistance, you can bring style context from your Figma Design library into Figma Make. This allows you to maintain design consistency while leveraging AI-powered development capabilities.
...
> **Note:** The following article is reproduced verbatim from  
> Carly Ayres, *Carly Substack* (2025):  
> [A designer's guide to engaging with AI](https://carly.substack.com/p/a-designers-guide-to-engaging-with)  
> for internal educational use only (non-profit).
...
> **Note:** The following article is reproduced verbatim from  
> Agentic Path Design Team, *Agentic Path Design* (2025):  
> [GenAI UX Design Patterns](https://www.agenticpathdesign.com/ai-patterns)  
> for internal educational use only (non-profit).

# GenAI UX Design Patterns

AI introduces a new way for humans to interact with computers by focusing on intent-based outcome specification. Designing AI isn't just about the model but it's about the experience.

Gen AI design patterns help teams create products that are intuitive, trustworthy, and effective. They provide a shared language for product managers, data scientists, and interaction designers to collaborate seamlessly. By applying these patterns, we can bridge the gap between technical capabilities and user needs, making AI more useful, ethical, and human-centred.

20+ GenAI UX patterns, examples and implementation tactics

Published by UX Collective on Medium

## Design for User Needs

- **GenAI or no GenAI**: Determining when to use AI vs traditional interfaces
- **Define Level of Automation**: Choosing the right level of AI assistance
- **Convert User Needs to Data Needs**: Translating user requirements into AI requirements
- **Augment vs Automate**: Deciding between AI augmentation and full automation

## Design for Trust and Decision Making

- **Trust Indicators**: Building user confidence in AI systems
- **Decision Transparency**: Making AI decision-making processes clear
- **Confidence Levels**: Communicating AI certainty and limitations
- **Explainable AI**: Providing understandable explanations for AI outputs
- **Human Oversight**: Ensuring human control and intervention capabilities
- **Bias Awareness**: Addressing and mitigating AI biases
- **Ethical Considerations**: Incorporating ethical principles in AI design
- **Privacy Protection**: Safeguarding user data and privacy

## Design for User Controls

- **User Customization**: Allowing users to personalize AI behavior
- **Override Mechanisms**: Providing ways for users to override AI decisions
- **Granular Controls**: Offering detailed control over AI functionality

## Design for AI Errors, Model Improvement and Safety

- **Error Handling**: Gracefully managing AI failures and mistakes
- **Fallback Options**: Providing alternatives when AI systems fail
- **Model Feedback**: Collecting user feedback to improve AI models
- **Safety Measures**: Implementing safeguards to prevent harmful AI behavior
- **Continuous Learning**: Enabling AI systems to improve over time
